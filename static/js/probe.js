...
function renderCharts() {
	/*
	 * Based upon D3 examples...
	 *   http://bl.ocks.org/mbostock/1157787
	 *   http://bl.ocks.org/marufbd/7191340
	 */

   // Determine the boundaries of the graphs
   var graphWidth = $(".sensorGraphs")[0].offsetWidth;
   var graphHeight = $(".sensorGraphs")[0].offsetHeight;
...
d3.csv("/static/stocks.csv", type, function(error, data) {
